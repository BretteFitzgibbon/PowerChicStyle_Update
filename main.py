...
def main():
  ...
  socks_proportional_surplus = get_stats(socks, socks_not_available, max_wears)
  ...
  shoes_proportional_surplus = get_stats(shoes, shoes_not_available, max_wears)
  ...
  ponytail_proportional_surplus = get_stats(ponytail, ponytail_not_available, max_wears)
  ...
  utilitarian_headbands_proportional_surplus = get_stats(utilitarian_headbands, utilitarian_headbands_not_available, max_wears)
  ...
  phone_cases_proportional_surplus = get_stats(phone_cases, phone_cases_not_available, max_wears)
  ...
  club_dresses_proportional_surplus = get_stats(club_dresses, club_dresses_not_available, max_wears)
  ...
  workout_tops_proportional_surplus = get_stats(workout_tops, workout_tops_not_available, max_wears)
  workout_bottoms_proportional_surplus = get_stats(workout_bottoms, workout_bottoms_not_available, max_wears)
  ...
  new_years_proportional_surplus = get_stats(new_years, new_years_not_available, max_wears)
  ...
  print("Shoes\n")
  get_stats(shoes, shoes_not_available, max_wears)
  ...
  print("Ponytail\n")
  get_stats(ponytail, ponytail_not_available, max_wears)
  ...
  print("Phone Cases\n")
  get_stats(phone_cases, phone_cases_not_available, max_wears)
